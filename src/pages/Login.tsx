...
const Login = () => {
    return (
        ...
        bg-gradient-to-b
         from-pink-700/80 to-red-600/80 '>
              ...
              rounded text-sm'
                        ...
                        <div>
                            <Link to={"/forgot-password"}>
                                <a className='text-xs text-gray-500 leading-7' href="">Forgot password</a>
                            </Link>
                        </div>
                        <SubmitBtn title='Sign in' />
                        <div className='text-center mt-2'>
                            <Link to={"/register"}>
                                <a className='text-xs text-red-500 font-medium  leading-7' href="">Create an account</a>
                            </Link>
                        </div>
                    </form>
                </div>
